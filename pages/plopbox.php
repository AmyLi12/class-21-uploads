...
// 1 MB = 1000000 bytes
define("MAX_FILE_SIZE", 1000000); // have to define this in PHP otherwise it won't know what you're talking about
// also can be changed depending on your audience's needs
